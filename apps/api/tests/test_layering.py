...
#: `text(` calls inside routers on 2026-09-12: admin.py 31, auth.py 21, users.py 14,
#: plugins.py 13, files.py 8, and a tail across the rest. Routers shape and authorize;
#: the SQL belongs in services. Lower this number as it moves, never raise it.
ROUTER_SQL_CEILING = 131
