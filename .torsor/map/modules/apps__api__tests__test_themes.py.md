...
Symbols in `apps/api/tests/test_themes.py`.

- L20 `team(client: Client)` (function)
- L32 `test_accepts_colours(value: str)` (function)
- L46 `test_rejects_anything_that_is_not_plainly_a_colour(value: str)` (function)
- L52 `test_rejects_tokens_outside_the_allowlist()` (function)
- L61 `test_every_preset_only_uses_themeable_tokens()` (function)
- L69 `test_presets_are_available_to_everyone(team: dict)` (function)
