...
- L86 `verify_response_token(token: str, *, now: int | None=None)` (function) — Recover the target, or None for anything forged, malformed or expired.
- L112 `parse_reply(status_code: int, body: bytes)` (function) — Read what an app sent back.
- L143 `ask(*, url: str, secret: str, payload: dict[str, Any])` (function) — Ask an app to answer a command.
