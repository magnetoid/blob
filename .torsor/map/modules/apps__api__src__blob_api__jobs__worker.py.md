...
- L94 `deliver_plugin_events(_ctx: dict[str, Any])` (function) — Drain the plugin outbox.
- L106 `startup(_ctx: dict[str, Any])` (function)
- L112 `shutdown(_ctx: dict[str, Any])` (function)
- L120 `WorkerSettings` (class)
