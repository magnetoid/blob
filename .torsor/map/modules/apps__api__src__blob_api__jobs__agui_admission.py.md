...
- L166 `_is_private_room_with(session: AsyncSession, *, channel_id: str, user_id: str, bot_user_id: str)` (function) — Is this channel a DM holding exactly this person and this agent?
- L197 `agent_tools(listener: Listener, *, workspace_id: str, user_id: str, channel_id: str)` (function) — The tools this agent may use, and a runner that runs them as the person who asked.
- L299 `looks_busy(listener: Listener, channel_id: str, thread_root_id: str | None)` (function) — Show the agent typing for as long as it is thinking.
