...
- L84 `test_the_workspace_form_never_reads_channels_you_are_not_in(self, team: dict, model_speaks: list)` (method)
- L95 `test_no_model_is_a_clean_refusal(self, team: dict, monkeypatch)` (method)
