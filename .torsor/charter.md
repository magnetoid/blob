...
Blob is a self-hosted, Slack-class team chat app: channels, DMs, threads, reactions,
mentions, full-history search and live presence, with a superadmin console, a theme
system and an app platform. One workspace per deployment, run by the team that uses it.
...
a hundred people who want the former's feel on the latter's terms.
